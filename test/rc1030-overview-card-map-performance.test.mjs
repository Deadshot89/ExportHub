...
test('RC1030: ruhiger Overview-Patch scannt Karten einmal und reicht eine Map weiter',()=>{
...
test('RC1030: Karten-Patch nutzt vorberechnete Map statt N einzelner Root-querySelector',()=>{
