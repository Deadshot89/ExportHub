...
var P={
 version:'RC545', dateFormat:'TT.MM.JJJJ', locale:'de-DE',
...
function save(){try{if(window.ExportHUBClean&&window.ExportHUBClean.queueSave)window.ExportHUBClean.queueSave('RC545 Prozessregeln');}catch(e){}}
function installPolicy(){var s=state();s.settings=s.settings||{};s.settings.finalProcessVersion='RC545';s.settings.dateFormat='TT.MM.JJJJ';s.settings.qrPin=s.settings.qrPin||'2578';s.settings.processPolicy=P;save();}
...
function markVersion(){document.documentElement.setAttribute('data-exporthub-version','RC545');document.querySelectorAll('[data-exporthub-version-label]').forEach(function(n){n.textContent='RC545'})}
