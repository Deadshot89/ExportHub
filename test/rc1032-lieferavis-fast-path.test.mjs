...
test('RC1032: Auto-Lieferavis umgeht den alten Vollspeicher-Pfad', () => {
...
test('RC1032: Fast-Path sendet nur einen kleinen Avis-Entwurf', () => {
...
test('RC1032: API kann eine noch ungespeicherte Sendung beim Avis-Issue minimal materialisieren', () => {
