...
test('RC1161: nur der Live-Hauptnavigationstest erhält 120 Sekunden Zeitbudget',()=>{
  ...
  assert.match(block,/if\(process\.env\.EXPORTHUB_E2E_LIVE==='1'\)test\.setTimeout\(120_000\)/);
});
