'use strict';
let BlobServiceClientRef=null;
function blobService(){if(!BlobServiceClientRef)BlobServiceClientRef=require('@azure/storage-blob').BlobServiceClient;return BlobServiceClientRef}
...
function containerClient(){
 ...
 return blobService().fromConnectionString(cs).getContainerClient(DOCUMENT_CONTAINER);
}
