...
test('RC1041: Produktion TESTSERVICE und Demo zeigen die aktuelle sichtbare Release-Version',()=>{
  ...
  execFileSync(process.execPath,['.github/rc1041/apply-release-version.mjs'],{cwd:ROOT,stdio:'pipe'});
  ...
  const probe=fs.readFileSync(path.join(ROOT,'dist-rc1018','production-version.js'),'utf8');
