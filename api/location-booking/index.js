...
module.exports=async function(context,req){
 ...
 try{
  ...
  if(a==='list'){requireApp(req);context.res=response(200,{ok:true,records:await listRecords(),version:'RC669'});return}
 ...
 }catch(e){context.log&&context.log.error&&context.log.error('location-booking RC669',e&&e.code,e&&e.message);context.res=response(e.status||500,{ok:false,code:e.code||'SERVER_ERROR',message:e.message||'Location konnte nicht verarbeitet werden.'});}
};
