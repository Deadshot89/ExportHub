...
if(!environmentHubBuilt.includes("android.time")||!environmentHubBuilt.includes("android.diagnosticTitle"))throw new Error('RC1277 lokalisierter Android-Diagnose-Hub fehlt im finalen Build');
