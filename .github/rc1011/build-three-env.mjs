...
function sopReleaseTag(){return `<script id="exporthub-rc1011-sop-release" src="${SOP_RELEASE_SRC}"><\/script>`;}
...
function prepare(html,env,isDemo=false){
  ...
  out=injectBeforeHeadClose(out,sopReleaseTag(),'exporthub-rc1011-sop-release');
...
console.log('RC1011 build ready: Produktion, TESTSERVICE und Demo auf gemeinsamem Kernfehler-Fixstand');
