...
test('RC1012: Wochenansicht kann exakt eine Woche vor und zurück verschoben werden', () => {
  ...
  assert.equal(next.days[2].fixed.length,1);
...
test('RC1012: Oberfläche besitzt vollständige Wochennavigation', () => {
...
test('RC1012: SENDUNG-Karte öffnet über stabile Identität die bestehende Sendung', () => {
