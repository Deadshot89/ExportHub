...
test('RC1047 TESTSERVICE-Ausnahmeweg nutzt denselben aktuellen Release auf der RC1046/RC1045/RC1044/RC1018-Buildkette',()=>{
  ...
  assert.match(flow,/RC1047 TESTSERVICE-Ausnahmevertrag prüfen/);
  ...
  assert.match(wrapper,/\.github\/rc1046\/build-three-env\.mjs/);
  assert.match(previous,/\.github\/rc1045\/build-three-env\.mjs/);
  assert.match(base,/\.github\/rc1044\/build-three-env\.mjs/);
  assert.match(foundation,/\.github\/rc1018\/build-three-env\.mjs/);
...
test('RC1047 TESTSERVICE-Ausnahmeweg bleibt nur nach ausdrücklicher Abweichungsfreigabe nutzbar',()=>{
