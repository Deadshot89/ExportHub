...
const RC1027_TAG='<script id="'+RC1027_ID+'" defer src="/assets/rc1027-lieferavis-immediate.js?v=1291"></script>';
...
function patchRc1089AvisCalendarDays(rel){
 ...
 const replacements=[
  ...
  ["customerAvisAutoDisabledReason:'3 Arbeitstage nach tatsächlicher Abholung',avisAutoDisabledReason:'3 business days after actual collection'","customerAvisAutoDisabledReason:'14 Tage nach tatsächlicher Abholung',avisAutoDisabledReason:'14 calendar days after actual collection'"],
  ["persist('Kunden-Avis automatisch nach 3 Arbeitstagen deaktiviert')","persist('Kunden-Avis automatisch nach 14 Tagen deaktiviert')"],
  ["IMPORTANT: This link is automatically deactivated three business days after the actual collection. Saturday and Sunday are not counted. Essentra can disable it earlier.","IMPORTANT: This link remains available through 14 calendar days after the actual collection and is then automatically deactivated. Essentra can disable it earlier."],
  ["WICHTIG: Der Link wird drei Arbeitstage nach der tatsächlichen Abholung automatisch deaktiviert. Samstag und Sonntag zählen nicht mit. Essentra kann ihn vorher deaktivieren.","WICHTIG: Der Lieferavis-Link bleibt bis einschließlich 14 Kalendertage nach der tatsächlichen Abholung verfügbar und wird anschließend automatisch deaktiviert. Essentra kann ihn vorher deaktivieren."],
  ["Note: The delivery notice link remains valid until three business days after the actual collection and is then automatically deactivated. Saturdays and Sundays are not counted as business days. Essentra can deactivate the link earlier at any time.","Note: The delivery notice link remains available through 14 calendar days after the actual collection and is then automatically deactivated. Essentra can deactivate the link earlier at any time."],
  ["Hinweis: Der Lieferavis-Link bleibt bis drei Arbeitstage nach der tatsächlichen Abholung gültig und wird anschließend automatisch deaktiviert. Samstage und Sonntage gelten dabei nicht als Arbeitstage. Essentra kann den Link jederzeit vorzeitig deaktivieren.","Hinweis: Der Lieferavis-Link bleibt bis einschließlich 14 Kalendertage nach der tatsächlichen Abholung verfügbar und wird anschließend automatisch deaktiviert. Essentra kann den Link jederzeit vorzeitig deaktivieren."]
 ];
 ...
 if(avis&&!avis.includes('addCalendarDays(picked,14)'))throw new Error(rel+': RC1089 Kalenderablauf fehlt.');
