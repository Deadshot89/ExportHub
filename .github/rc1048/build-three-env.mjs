...
function gateMasterAdmin(){var u=gateMasterUser()||{},role=low(u.role||u.rolle),rights=u.rights||{},r=rights.shippingcosts||rights.shippingCosts||rights.shipping||{},roles=['global admin','globaler administrator','globaler admin','administrator','admin','vollzugriff'];if(u.globalAdmin===true||u.isGlobalAdmin===true||u.isAdmin===true||u.admin===true||arr(u.permissions).indexOf('*')>=0||roles.indexOf(role)>=0)return true;return r.admin===true||r.functionAdmin===true||low(r.level||r.access)==='admin'}
