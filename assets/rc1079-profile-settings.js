...
function install(){
 ...
 box.innerHTML='<div><span class="pill blue">PROFIL</span><h3>Mein Profil</h3><p>Der Benutzername bleibt für die Anmeldung unverändert. Den Anzeigenamen kannst du jederzeit ändern; neue Historie-Einträge verwenden anschließend den neuen Namen.</p></div><div class="rc1079-profile-grid"><label>Benutzername<input data-rc1079-user readonly></label><label>Anzeigename<input data-rc1079-name maxlength="80" autocomplete="name"></label><button type="button" class="btn" data-rc1079-save>Anzeigename speichern</button></div><div class="rc1079-note">Bereits gespeicherte Historie-Einträge behalten aus Nachvollziehbarkeitsgründen den Namen, der zum damaligen Zeitpunkt verwendet wurde.</div><div data-rc1079-status></div>';
