...
module.exports=async function(context,req){
  try{
    ...
    await store.clients();
    context.res=store.json(200,{ok:true,api:true,storage:true,version:'RC547',containers:{records:store.RECORD_CONTAINER,pod:store.POD_CONTAINER,team:store.TEAM_CONTAINER}})
