...
test('RC1159: Kundenportal-Rechte sind eigenständig und standardmäßig gesperrt',()=>{
...
test('RC1159: Global Admin besitzt Kundenportal verwenden und verwalten automatisch',()=>{
...
test('RC1159: customerPortal ist kein Navigationsmodul',()=>{
