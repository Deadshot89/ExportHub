...
function patchHtml(file){
  ...
  if(!html.includes('assets/rc1176-shipment-location.js?v=1196'))throw new Error(file+': RC1196 Standort-Capture-Runtime fehlt');
...
fs.writeFileSync(path.join(OUT,'rc1112-manifest.json'),JSON.stringify({
  ...
  releaseFixes:{
    ...
    shipmentLocationPersistence:'RC1196 current-draft priority + same-customer rerender persistence + real customer-change guard',
