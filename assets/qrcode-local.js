/*
 Local QR generator for ExportHUB RC540.
...
function req(id){if(cache[id])return cache[id].exports;if(!modules[id])throw new Error('QR module missing: '+id);var m=cache[id]={exports:{}};modules[id](m,m.exports,req);return m.exports}
...
global.ExportHUBQRCode={svg:svg,QRCode:QRCode,ErrorCorrectLevel:Level,version:'RC540-local'};
})(window);
