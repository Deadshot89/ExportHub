...
const MAX_RETRIES=6;
const LOCATIONS={0:'Eingang',1:'Regal',2:'Lane 1',3:'Lane 2',4:'Lane 3',5:'Lane 4',6:'Lane 5',7:'Vor dem Regal'};
...
module.exports=async function(context,req){
 ...
 try{
  ...
  if(a==='list'){requireApp(req);context.res=response(200,{ok:true,records:await listRecords(),version:'RC646'});return}
 ...
 }catch(e){context.log&&context.log.error&&context.log.error('location-booking RC646',e&&e.code,e&&e.message);context.res=response(e.status||500,{ok:false,code:e.code||'SERVER_ERROR',message:e.message||'Location konnte nicht verarbeitet werden.'});}
};
