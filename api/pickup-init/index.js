...
module.exports=async function(context,req){
 ...
 try{
  ...
  if(!snapshot.address&&typeof store.resolveShipmentAddress==='function'){try{snapshot.address=await store.resolveShipmentAddress(Object.assign({},src,{shipmentId,reference}),issued.environment)}catch(_){}}
