...
test('RC1232: QR-Abholung initialisiert nur den primaeren Pickup-Speicher',()=>{
...
test('RC1232: POD-Archiv wird nur bei echter Backup-Arbeit initialisiert',()=>{
...
test('RC1232: interner Dokument-Endpunkt erlaubt nur automatische POD-PDFs aus dem Pickup-Speicher',()=>{
...
test('RC1232: Browser-Viewer erkennt signierte automatische POD-Ladelisten, aber keine Fahrer-Signaturdateien',()=>{
  const window={
...
test('RC1232: geaenderte Runtime-Dateien bleiben syntaktisch gueltig',()=>{
  for(const path of [
