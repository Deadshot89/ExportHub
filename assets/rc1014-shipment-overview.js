(function(root){
  ...
  function createConfigPanel(doc){
    ...
    panel.innerHTML='<div class="rc1259-config-title"><strong>'+tr('container.configTitle')+'</strong><span>'+tr('container.configHelpShort')+'</span></div><div class="rc1259-config-grid"><label>'+tr('container.transportMode')+'<select data-rc1259-transport><option value="">'+tr('container.notSet')+'</option><option value="road">'+tr('container.road')+'</option><option value="air">'+tr('container.air')+'</option><option value="sea">'+tr('container.sea')+'</option></select></label><label>'+tr('container.sealInput')+' <span class="rc1259-field-note">('+tr('common.optional')+')</span><input type="text" data-rc1259-seal autocomplete="off" maxlength="120" placeholder="'+tr('container.sealPlaceholder')+'"></label><label class="rc1259-required-label"><input type="checkbox" data-rc1259-required> '+tr('container.requiredDocumentation')+'</label></div><div class="rc1259-config-help">'+tr('container.configHelp')+'</div>';
