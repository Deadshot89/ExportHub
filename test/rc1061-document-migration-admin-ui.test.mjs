...
function loadRuntime(){
  ...
  vm.createContext(context);vm.runInContext(code,context);return{api:context.window.ExportHUBRC1061DocumentMigrationAdmin,calls};
}
...
test('RC1061: Release-Vorbereitung hält die Admin-Steuerung ausschließlich an der finalen Build-Grenze',()=>{
  ...
  assert.match(prep,/assets\/rc1061-document-migration-admin\.js/);assert.match(prep,/for\(const file of \['index\.html','TESTVERSION\.html'\]\)/);
