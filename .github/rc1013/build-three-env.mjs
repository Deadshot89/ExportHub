...
copy('assets/abholkalender.js');copy('assets/abholkalender.css');copy('assets/rc1012-abholkalender-runtime.js');copy('assets/rc1013-diagnostics.js');copy('assets/rc1013-gate41-ui.js');copy('assets/rc1015-lieferavis-mail-flow.js');
