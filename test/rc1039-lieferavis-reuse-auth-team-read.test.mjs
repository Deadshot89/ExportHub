...
test('RC1039: production issue reuses the authenticated team document instead of downloading team-state twice',async()=>{
...
test('RC1039: testservice keeps its separate team-state read and must not reuse the production auth document',async()=>{
