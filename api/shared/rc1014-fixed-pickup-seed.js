...
const OBSOLETE_V1_IDS = new Set([
  'FIX-RC1014-ESSENTRA-ES-DI',
  'FIX-RC1014-ESSENTRA-ES-FR',
  'FIX-RC1014-ESSENTRA-IT-MI',
  'FIX-RC1014-ESSENTRA-IT-FR',
  'FIX-RC1014-ESSENTRA-AIR-ASIA-DO',
  'FIX-RC1014-ESSENTRA-PL-FR',
  'FIX-RC1014-ESSENTRA-SE-FR',
  'FIX-RC1014-ESSENTRA-UK-MO',
  'FIX-RC1014-ESSENTRA-UK-DI',
  'FIX-RC1014-ESSENTRA-UK-MI',
  'FIX-RC1014-ESSENTRA-UK-DO',
  'FIX-RC1014-ESSENTRA-UK-FR',
  'FIX-RC1014-ESSENTRA-OHARE-DO',
  'FIX-RC1014-ESSENTRA-OHARE-FR'
]);
...
function isUntouchedObsoleteV1(item){
  ...
  const createdBy = text(item && item.createdBy);
  const updatedBy = text(item && item.updatedBy);
