...
test('RC1155: responsive Hauptnavigation öffnet das echte Seitenmenü vor der Modulsuche',()=>{
...
test('RC1155: Browser-Gate wartet auf echte Azure-Saves statt ERR_ABORTED zu ignorieren',()=>{
...
test('RC1155: Abholdatum-Test prüft genau die von ihm gesetzte Sendung',()=>{
...
test('RC1155: historischer RC1016-Vertrag akzeptiert den aktuellen Aufgaben-Runtime-Cache-Key',()=>{
...
test('RC1155: pagehide startet ohne echte Sendungsänderung keinen neuen Azure-Save',()=>{
