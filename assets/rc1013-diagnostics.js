(function(root,factory){
  ...
  function style(win){
    ...
    var s=win.document.createElement('style');s.id='rc1013-diagnostics-style';s.textContent='\n#rc1013-diagnostics-enhanced{margin:16px 0 22px;padding:18px;border:1px solid #cbd5e1;border-radius:18px;background:#f8fafc}#rc1013-diagnostics-enhanced .rc1013-head{display:flex;gap:12px;justify-content:space-between;align-items:flex-start;flex-wrap:wrap}#rc1013-diagnostics-enhanced .rc1013-list{display:grid;gap:12px;margin-top:14px}.rc1013-diag-card{background:#fff;border:1px solid #dbe4ef;border-left:6px solid #dc2626;border-radius:16px;padding:16px}.rc1013-diag-card.warning{border-left-color:#f59e0b}.rc1013-diag-top{display:flex;justify-content:space-between;gap:12px;flex-wrap:wrap}.rc1013-code{font:800 13px ui-monospace,SFMono-Regular,Consolas,monospace;background:#fee2e2;color:#991b1b;border-radius:999px;padding:5px 9px}.rc1013-meta{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin:12px 0}.rc1013-meta div,.rc1013-block{background:#f8fafc;border-radius:10px;padding:9px}.rc1013-meta b,.rc1013-block b{display:block;font-size:11px;text-transform:uppercase;color:#64748b;margin-bottom:4px}.rc1013-tech{font-family:ui-monospace,SFMono-Regular,Consolas,monospace;white-space:pre-wrap;word-break:break-word}.rc1013-details{margin-top:8px;font-size:12px;color:#475569;white-space:pre-wrap;word-break:break-word}@media(max-width:760px){#rc1013-diagnostics-enhanced .rc1013-meta{grid-template-columns:1fr 1fr}}@media(max-width:480px){#rc1013-diagnostics-enhanced .rc1013-meta{grid-template-columns:1fr}}';win.document.head.appendChild(s);
  }
  ...
  async function refresh(win){
    ...
    if(!host){host=win.document.createElement('section');host.id='rc1013-diagnostics-enhanced';rootEl.insertBefore(host,rootEl.firstChild||null);}
