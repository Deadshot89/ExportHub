...
module.exports=async function(context,req){
 ...
 }catch(e){context.log&&context.log.error&&context.log.error('customer-avis RC1129',e&&e.code,e&&e.message);context.res=json(e.status||e.statusCode||500,{ok:false,code:e.code||'SERVER_ERROR',message:e.message||'Kunden-Avis ist vorübergehend nicht verfügbar.'})}
};