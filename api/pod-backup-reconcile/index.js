...
module.exports = async function(context, req) {
  ...
  try {
    ...
    context.res = json(200, Object.assign({ version: 'RC1226', backupMode: 'azure-archive', graphConfigured: graph.configured, reference: reference || null }, result));
  } catch (e) {
    try { context.log && context.log.error && context.log.error('RC1144 POD reconcile failed', e && e.code, e && e.message); } catch (_) {}
    context.res = json(e.status || e.statusCode || 500, { ok: false, code: e.code || 'SERVER_ERROR', message: e.message || 'POD-Nachholung ist fehlgeschlagen.', version: 'RC1226' });
  }
};
