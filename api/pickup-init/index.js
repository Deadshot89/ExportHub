...
module.exports=async function(context,req){
 ...
 }catch(e){context.log&&context.log.error&&context.log.error('pickup-init RC644',e&&e.code,e&&e.message);context.res=store.json(e.status||500,{ok:false,code:e.code||'INIT_FAILED',message:e.message||'QR-Code konnte nicht registriert werden.'})}
};
