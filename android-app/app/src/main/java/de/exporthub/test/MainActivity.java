...
public class MainActivity extends Activity {
    ...
    private static final String START_URL = "https://" + TEST_HOST + "/TESTVERSION.html?entry=android&app=1";
    ...
    private void configureWebView() {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " ExportHUB-Android-Test/1.0 RC876");
    ...
    private class ExportHubWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            Uri starting = Uri.parse(url == null ? "" : url);
            if (PROD_HOST.equalsIgnoreCase(starting.getHost())) {
                view.stopLoading();
                Toast.makeText(MainActivity.this,
                        "Produktion ist in der ExportHUB Test-App gesperrt.", Toast.LENGTH_LONG).show();
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (PROD_HOST.equalsIgnoreCase(current.getHost())) {
                Toast.makeText(MainActivity.this,
                        "Produktion ist in der ExportHUB Test-App gesperrt.", Toast.LENGTH_LONG).show();
                view.loadUrl(START_URL);
                return;
    ...
    private boolean handleNavigation(Uri uri) {
        ...
        if ("https".equals(scheme) && TEST_HOST.equals(host)) {
            return false;
        }
        if ("https".equals(scheme) && PROD_HOST.equals(host)) {
            Toast.makeText(this,
                    "Produktion ist in der Test-App gesperrt.", Toast.LENGTH_LONG).show();
            return true;
        }
    ...
    private class ExportHubDownloadListener implements DownloadListener {
        ...
        public void onDownloadStart(String url, String userAgent, String contentDisposition,
            ...
            if (!TEST_HOST.equalsIgnoreCase(uri.getHost())) {
    ...
    private void setConnectivityState(boolean online) {
        ...
        if (online) {
            connectivityBanner.setText("Verbindung wiederhergestellt");
        } else {
            connectivityBanner.setText("Offline – Eingaben erst nach Wiederverbindung absenden");
        }
    }
