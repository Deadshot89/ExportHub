...
test('RC1047 Main-Contract schützt aktuellen Release und historische Release-Basis',()=>{
  assert.match(flow,/name: RC1047 Main Contract/);
  ...
  assert.match(flow,/\.github\/rc1046\/\*\*/);
  assert.match(flow,/\.github\/rc1047\/\*\*/);
  ...
  assert.match(flow,/RC1013 Baseline und RC1047 Produktionsmarker prüfen/);
  assert.match(flow,/__EXPORTHUB_PRODUCTION_VERSION_PROBE__='RC1047'/);
