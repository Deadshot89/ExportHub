...
const MAX_RETRIES=6;
const LOCATIONS={0:'Eingang',1:'Lane 1',2:'Lane 2',3:'Lane 3',4:'Lane 4',5:'Lane 5',6:'Regal 6',7:'Regal 7'};
...
module.exports=async function(context,req){
 ...
 try{
  ...
  if(a==='list'){requireApp(req);context.res=response(200,{ok:true,records:await listRecords(),version:'RC654'});return}
 ...
 }catch(e){context.log&&context.log.error&&context.log.error('location-booking RC654',e&&e.code,e&&e.message);context.res=response(e.status||500,{ok:false,code:e.code||'SERVER_ERROR',message:e.message||'Location konnte nicht verarbeitet werden.'});}
};
