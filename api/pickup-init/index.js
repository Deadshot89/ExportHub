...
module.exports=async function(context,req){
 ...
 try{
  ...
  context.res=store.json(200,Object.assign({ok:true,registered:true,token:issued.token,environment:issued.environment,oneTime:false,version:'RC1014',multiTruckVersion:'RC1017'},store.publicRecord(record,issued.token)));
