(function(w){
 ...
 function endpoint(file){if(!isBlobDocument(file))throw new Error('Ungültige ExportHUB-Dokumentreferenz.');return'/api/exporthub-document?blob='+encodeURIComponent(blobName(file))+'&environment='+encodeURIComponent(environment())}
